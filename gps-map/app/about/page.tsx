export default function AboutPage() {
    return (
        <div className="py-20 px-6 max-w-4xl mx-auto">
            <h1 className="text-4xl font-bold text-cyan-800 mb-8">Giới thiệu dự án</h1>
            <p className="text-gray-700 text-lg leading-relaxed mb-4">
                Hệ thống giám sát hành trình đường sắt (GPS Tracking) là giải pháp quản lý tàu hiện đại.
