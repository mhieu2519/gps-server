...
export default function TrainRouteProgress({
    ...
    return (
        <div className="w-full bg-gray-50 p-4 rounded-xl border border-gray-200 my-3 select-none">
            ...
            <div className="relative w-full px-3 overflow-x-auto flex items-start [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">

                <div className="relative flex items-center justify-between w-full pb-4">
                    {/* Đường nối ray nền xám cố định */}
                    <div className="absolute left-[11px] right-[11px] top-1/2 -translate-y-1/2 h-1 bg-gray-200 rounded z-0"></div>
                    ...
                    <div
                        ...
                        style={{
                            left: '11px',
                            width: `calc((100% - 22px) * ${progressPercent} / 100)`
